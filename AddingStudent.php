...
<html>
    ...
    <body>
        ...
        <form action="StudentAdded.php" method="POST" id="form2">
            ...
            <label><h4>Age:</h4><input type="text" name="age"></label>
            <br><br>
            ...
            <label><h4>Permission Slip on File:</h4>
                Yes<input type="radio" value="Y" name="permission_slip">
                No<input type="radio" value="N" name="permission_slip">
            </label>
            <br><br>
            
            <label><h4>Birth Certificate on File:</h4>
                Yes<input type="radio" value="Y" name="birth_certificate">
                No<input type="radio" value="N" name="birth_certificate">
            </label>
            <br><br>
