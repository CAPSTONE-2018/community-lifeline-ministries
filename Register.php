...
<html>
    ...
    <body>
        ...
        <form action="Registered.php" method="POST" id="form2">
			...
			<label><h4>Username:</h4><input type="text" name="username"></label><br><br>
			<label><h4>Password:</h4><input type="text" name="password"></label><br><br>
            <label><h4>Account type (administrator or teacher):</h4><input type="text" name="account"></label><br><br>
			<label><h4>First Name:</h4><input type="text" name="fname"></label><br><br>
            <label><h4>Last Name:</h4><input type="text" name="lname"></label><br><br>
