...
INSERT INTO Contacts(Author_Username, Active_Contact, Prefix, First_Name, Last_Name, Primary_Phone, Secondary_Phone, Address_One, Address_Two, City, State, Zip, Email) VALUES ("Developer", 1, "Mrs.", "Marilee", "Muller", "630-350-4389", "630-833-8899", "454 Royal Oaks Drive", "Apt 11B", "Wooddale", "IL", 60105, "muller@gmail.com");
INSERT INTO Contacts(Author_Username, Active_Contact, Prefix, First_Name, Last_Name, Primary_Phone, Address_One, Address_Two, City, State, Zip, Email) VALUES ("Developer", 1, "Mr.", "Bruce", "Alder", "773-240-0223", "250 Red Oaks Drive", "Apt B", "Bensenville", "IL", 60103, "bruce@yahoo.com");
INSERT INTO Contacts(Author_Username, Active_Contact, Prefix, First_Name, Last_Name, Primary_Phone, Secondary_Phone, Address_One, City, State, Zip, Email) VALUES ("Developer", 1, "Mr.", "Paul", "Shall", "630-567-3322", "630-483-2234", "350 Forest Preserve Drive", "Wooddale", "IL", 60105, "shall@gmail.com");
INSERT INTO Contacts(Author_Username, Active_Contact, Prefix, First_Name, Last_Name, Primary_Phone, Secondary_Phone, Address_One, Address_Two, City, State, Zip, Email) VALUES ("Developer", 1, "Mrs.", "Pamela", "Ellery", "630-333-2453", "630-889-3299", "400 S Mason St", "Apt 3D", "Bensenville", "IL", 60103, "pam1@gmail.com");
INSERT INTO Contacts(Author_Username, Active_Contact, Prefix, First_Name, Last_Name, Primary_Phone, Secondary_Phone, Address_One, Address_Two, City, State, Zip, Email) VALUES ("Developer", 1, "Mrs.", "Andrea", "Wisnowski", "630-924-4592", "630-321-1299", "323 Judson St", "Suite 4" ,"Addison", "IL", 60101, "andrea@gmail.com");
...
INSERT INTO Volunteer_Employees(Author_Username, Prefix, First_Name, Last_Name, Primary_Phone, Address_One, Address_Two, City, State, Zip, Email) VALUES ("Developer", "Mrs.", "Anna", "Smith", "773-345-6372", "101 Woodlawn Ave", "Condo 4", "Glen Ellyn", "IL", 60143, "smith43@gmail.com");
INSERT INTO Volunteer_Employees(Author_Username, Prefix, First_Name, Last_Name, Primary_Phone, Address_One, City, State, Zip, Email) VALUES ("Developer", "Mr.", "Johnny", "Donofrio", "847-532-2135", "727 Howard Dr", "Elmhurst", "IL", 60107, "donofrio@gmail.com");
INSERT INTO Volunteer_Employees(Author_Username, Prefix, First_Name, Last_Name, Primary_Phone, Address_One, City, State, Zip, Email) VALUES ("Developer", "Mrs.", "Catherine", "Lake", "630-943-1254", "612 Forest View Dr", "Addison", "IL", 60101, "lake@gmail.com");
INSERT INTO Volunteer_Employees(Author_Username, Prefix, First_Name, Last_Name, Primary_Phone, Secondary_Phone, Address_One, Address_Two, City, State, Zip, Email) VALUES ("Developer", "Mrs.", "Jamie", "Morgan", "630-777-1321", "630-234-4333", "221 Barron St", "Apt 345", "Bensenville", "IL", 60103, "morgan@gmail.com");
INSERT INTO Volunteer_Employees(Author_Username, Prefix, First_Name, Last_Name, Primary_Phone, Secondary_Phone, Address_One, Address_Two, City, State, Zip, Email) VALUES ("Developer", "Mrs.", "Nancy", "Jacobs", "630-943-4422", "847-298-9824", "231 Breiter Ct", "Apt 617", "Bensenville", "IL", 60103, "jacobs@gmail.com");
...
INSERT INTO Student_To_Contacts(Author_Username, Student_Id, Conctact_Id, Relationship) VALUES ("Developer", 1, 3, "Uncle");
INSERT INTO Student_To_Contacts(Author_Username, Student_Id, Conctact_Id, Relationship) VALUES ("Developer", 2, 2, "Father");
INSERT INTO Student_To_Contacts(Author_Username, Student_Id, Conctact_Id, Relationship) VALUES ("Developer", 3, 4, "Aunt");
INSERT INTO Student_To_Contacts(Author_Username, Student_Id, Conctact_Id, Relationship) VALUES ("Developer", 4, 5, "Mother");
INSERT INTO Student_To_Contacts(Author_Username, Student_Id, Conctact_Id, Relationship) VALUES ("Developer", 5, 1, "Neighbor");
