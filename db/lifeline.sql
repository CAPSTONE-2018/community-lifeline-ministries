...
CREATE TABLE Students (
    ...
    IEP TINYINT(1),
    CONSTRAINT FK_Author_Id_Students FOREIGN KEY (Author_Id)
        REFERENCES Logins(Id)
);
...
CREATE TABLE Allergies (
    ...
    Type VARCHAR(60),
    Note VARCHAR(500),
    CONSTRAINT FK_Author_Id_Allergies FOREIGN KEY (Author_Id)
        REFERENCES Logins(Id)
);
...
CREATE TABLE Student_To_Allergies (
    ...
    CONSTRAINT FK_Author_Id_Student_To_Allergies FOREIGN KEY (Author_Id)
        REFERENCES Logins(Id)
);
...
CREATE TABLE Attendance (
    ...
    CONSTRAINT FK_Author_Id_Attendance FOREIGN KEY (Author_Id)
        REFERENCES Logins(Id)
);
...
CREATE TABLE Contacts (
    ...
    Zip INT(5),
    Email VARCHAR(50),
    CONSTRAINT FK_Author_Id_Contacts FOREIGN KEY (Author_Id)
        REFERENCES Logins(Id)
);
...
CREATE TABLE Volunteer_Employees (
    ...
    Email VARCHAR(50),
    Type VARCHAR(10),
    CONSTRAINT FK_Author_Id_Volunteers FOREIGN KEY (Author_Id)
        REFERENCES Logins(Id)
);
...
CREATE TABLE Classes(
    ...
    CONSTRAINT FK_Author_Id_Classes FOREIGN KEY (Author_Id)
        REFERENCES Logins(Id)
);
...
CREATE TABLE Programs (
    ...
    CONSTRAINT FK_Author_Id_Programs FOREIGN KEY (Author_Id)
        REFERENCES Logins(Id)
);
...
CREATE TABLE Class_To_Programs (
    ...
    CONSTRAINT FK_Author_Id_Class_To_Programs FOREIGN KEY (Author_Id)
        REFERENCES Logins(Id)
);
...
CREATE TABLE Student_To_Classes(
    ...
    CONSTRAINT FK_Class_Id_Enrolled FOREIGN KEY (Class_Id)
        REFERENCES Classes(Id),
    CONSTRAINT FK_Author_Id_Student_To_Classes FOREIGN KEY (Author_Id)
        REFERENCES Logins(Id)
);
...
CREATE TABLE Student_To_Contacts(
    ...
    CONSTRAINT FK_Author_Id_Student_To_Contacts FOREIGN KEY (Author_Id)
        REFERENCES Logins(Id)
);
...
CREATE TABLE Volunteer_To_Programs(
    ...
    CONSTRAINT FK_Author_Id_Volunteer_To_Programs FOREIGN KEY (Author_Id)
        REFERENCES Logins(Id)
);
...
CREATE TABLE Schedules (
    ...
    CONSTRAINT FK_Volunteer_Id_Schedule FOREIGN KEY (Volunteer_Id)
        REFERENCES Volunteer_Employees (Id),
    CONSTRAINT FK_Author_Id_Schedules FOREIGN KEY (Author_Id)
        REFERENCES Logins(Id)
);
...
CREATE TABLE Student_To_Programs (
    ...
    CONSTRAINT FK_Program_Id_Program FOREIGN KEY (Program_Id)
        REFERENCES Programs(Id),
    CONSTRAINT FK_Author_Id_Student_To_Programs FOREIGN KEY (Author_Id)
        REFERENCES Logins(Id)
);
