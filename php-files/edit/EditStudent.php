        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" onclick="sendEditStudentForm()">Submit Student
                    </button>
                </div>
            </div>
        </div>
                                        ...
                                        <li class="tg-list-item">
                                            <input class="tgl tgl-flat" id="cb2" name="permissionSlipCheckbox"
                                                <?php echo $permissionChecked; ?>
                                                   value="<?php echo $studentPermissionSlip ?>"
                                                   type="checkbox"/>
                                        ...
                                        <li class="tg-list-item">
                                            <input class="tgl tgl-flat" id="cb3"
                                                ...
                                                <?php echo $birthCertificateChecked; ?>
                                                   value="<?php echo $studentBirthCertificate ?>"
                                                   type="checkbox"/>
                                    ...
                                    <ul class="tg-list">
                                        ...
                                        <li class="tg-list-item">
                                            <input class="tgl tgl-flat" id="cb1"
                                                   ...
                                                   value="<?php echo $studentReducedLunch ?>"
                                            />
