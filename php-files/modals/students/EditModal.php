                        ...
                        <div class="col-sm-6">
                            <div id="floatingStudentFirstName"
                                ...
                                <input id="studentFirstName" class="mdl-textfield__input"
                                       ...
                                       name="studentFirstName" type="text" value="<?php echo $studentFirstName; ?>"/>
                        ...
                        <div class="col-sm-6">
                            <div id="floatingStudentLastName"
                                ...
                                <input id="studentLastName" class="mdl-textfield__input"
                                       ...
                                       name="studentLastName" type="text" value="<?php echo $studentLastName; ?>"/>
                        ...
                        <div class="col-sm-6 col-lg">
                            <div id="floatingStudentMiddleName"
                                ...
                                <input id="studentMiddleName" class="mdl-textfield__input"
                                       ...
                                       name="studentMiddleName" type="text" value="<?php echo $studentMiddleName; ?>"/>
                        ...
                        <div class="col-sm-6">
                            <div id="floatingStudentSuffix"
                                ...
                                <input id="studentSuffix" class="mdl-textfield__input"
                                       ...
                                       name="studentSuffix" type="text" value="<?php echo $studentSuffix; ?>"/>
                        ...
                        <div class="col-sm-4">
                            <div id="floatingEthnicity"
                                ...
                                <input id="ethnicity" class="mdl-textfield__input"
                                       ...
                                       name="ethnicity" type="text" value="<?php echo $studentEthnicity; ?>"/>
                        ...
                        <div class="col-sm-6">
                            <div id="floatingStudentAddressOne"
                                ...
                                <input id="studentAddressOne" class="mdl-textfield__input"
                                       ...
                                       name="studentAddressOne" type="text" value="<?php echo $studentAddressOne; ?>"/>
                                <label class="mdl-textfield__label"
                        ...
                        <div class="col-sm-6">
                            <div id="floatingStudentAddressTwo"
                                ...
                                <input id="studentAddressTwo" class="mdl-textfield__input"
                                       ...
                                       name="studentAddressTwo" type="text" value="<?php echo $studentAddressTwo; ?>"/>
                                <label class="mdl-textfield__label"
                        ...
                        <div class="col-sm-10">
                            <div id="floatingStudentSchool"
                                ...
                                <input id="studentSchool" class="mdl-textfield__input"
                                       ...
                                       name="studentSchool" type="text" value="<?php echo $studentSchool; ?>"/>
