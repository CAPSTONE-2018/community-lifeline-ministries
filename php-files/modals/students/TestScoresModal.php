...
<div id="currentTest" class="medical-concern-modal">'; ?>
    <input id="hdnStudentId" type="hidden" value="<?php echo $studentId; ?>"/>
    ...
    <input id="deleteButton" type="button" class="btn btn-primary pull-right deleteButton"
           onclick="DeleteTestScore(<?php echo $testId; ?>)" value="Delete"/>
<?php }
$response .= '</div><div id="addTestScore" class="addTestScores">
        <div class="row form-group" >
            <div class="col-2 text-center mt-auto mb-auto">
                <i class="fa fa-bullhorn"></i>
            </div>
