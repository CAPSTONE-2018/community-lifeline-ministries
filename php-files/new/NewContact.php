                                ...
                                <div class="col-sm-5">
                                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                        <input id="contactLastName" class="mdl-textfield__input" name="contactLastName"
                                               type="text" pattern="^[A-Z]([ \-']?[a-zA-Z]+)*$" onkeypress="return suppressEnter()"/>
                                ...
                                <div class="col-sm-6">
                                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                        <input id="primaryPhone" class="mdl-textfield__input"
                                               ...
                                               pattern="^[2-9][0-9]{2}-[2-9][0-9]{2}-[0-9]{4}$" onkeypress="return suppressEnter()"/>
                                ...
                                <div class="col-sm-6">
                                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                        <input id="secondaryPhone" class="mdl-textfield__input" name="secondaryPhone"
                                               type="text" pattern="^[2-9][0-9]{2}-[2-9][0-9]{2}-[0-9]{4}$" onkeypress="return suppressEnter()"/>
                                ...
                                <div class="col-sm-12">
                                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                        <input id="contactEmail" class="mdl-textfield__input" name="contactEmail"
                                               type="text" pattern="^(?!\.).+@.+\..{2,5}$" onkeypress="return suppressEnter()"/>
                                ...
                                <div class="col-sm-6">
                                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                        <input id="contactAddressOne" class="mdl-textfield__input"
                                               ...
                                               pattern="^[A-Z0-9]+(([ \-\.']|(\. ))?[a-zA-Z0-9]+)*\.?$" onkeypress="return suppressEnter()"/>
                                        <label class="mdl-textfield__label"
                                ...
                                <div class="col-sm-6">
                                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                        <input id="contactAddressTwo" class="mdl-textfield__input"
                                               ...
                                               pattern="^[a-zA-Z0-9]+(([\- \.]|[(\. ))[a-zA-Z0-9]+)*$" onkeypress="return suppressEnter()"/>
                                        <label class="mdl-textfield__label"
                                ...
                                <div class="col-sm-4">
                                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                        <input id="contactZip" class="mdl-textfield__input" name="contactZip"
                                               type="text" pattern="^[0-9]{5}(-[0-9]{4})?$" onkeypress="return suppressEnter()"/>
