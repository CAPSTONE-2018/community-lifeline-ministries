    ...
    <div class="card">
        <div class="card-header">
            <ul class="nav nav-tabs card-header-tabs">
                <li class="nav-item">
                    <a data-target="#studentInfo" data-toggle="tab" class="nav-link">Student Info</a>
                </li>
                <li class="nav-item">
                    <a data-target="#studentMedicalConcerns" data-toggle="tab" class="nav-link">Medical Concerns</a>
                </li>
                <li class="nav-item">
                    <a data-target="#studentContact" data-toggle="tab" class="nav-link">Student Contact</a>
                </li>
            </ul>
        </div>
        <div class="card-body">
