...
<script type="text/javascript">
    function validateStudentToProgram() {
        ...
        studentName += " and Program, " + programName;
        $.ajax({
            ...
            success: function (response) {
                if (response === 'entry-exists') {
                    launchGenericDuplicateEntryModal(studentName, tableName);
                } else if (response === 'database-error') {
                    launchGenericDatabaseErrorModal();
                } else if (response === 'success') {
                    launchGenericSuccessfulEntryModal(studentName, tableName, afterModalDisplaysRoute);
