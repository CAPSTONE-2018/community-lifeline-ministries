...
$stmt = "SELECT Volunteer_Employee.First_Name, Volunteer_Employee.Last_Name, Classes.Class_Name, Schedule.Room_Number, Schedule.Start_Time, Schedule.End_Time, Schedule.Day
