            ...
            <div class=\"row\">
                <div class=\"form-group\">
                    <div class=\"col-lg-6\">
                        ...
                        <input id=\"allergyName\" class=\"form-control\" placeholder=$nameToDisplay type=\"text\"
                               name=\"name\">
                    </div>
                    <div class=\"col-lg-6\">
                        <label class=\"control-label\" for=\"allergyType\">Type:</label>
                        <input id=\"allergyType\" class=\"form-control\" placeholder=$typeToDisplay type=\"text\"
                               name=\"type\">
                    </div>
                </div>
            </div>
            <div class=\"row\">
                <div class=\"form-group\">
                    <div class=\"col-lg-11\">
                        ...
                        <textarea id=\"allergyNote\" class=\"form-control\" placeholder=$noteToDisplay name=\"note\"
                                  rows=\"4\" cols=\"50\">
                        </textarea>
                    </div>
                </div>
