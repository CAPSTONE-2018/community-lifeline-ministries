                    ...
                    <div class="table-responsive">
                        <table id="all-students-table" class="table table-striped table-condensed table-hover">
                            ...
                            <tr>
                                ...
                                <th class="col-sm-1 text-center">Program</th>
                            ...
                            while ($activeStudentsRow = mysqli_fetch_array($activeStudentResults, MYSQLI_ASSOC)) {
                                ...
                                echo "<tr class='number-row'>
                                    ...
                                    <td class='col-sm-4 align-middle'>$studentName</td>
                                    ...
                                    <td class='col-5 container-fluid'>
                                        ...
                                        <div class='left-action-buttons-container'>
                                            <div class='row m-auto'>
                                            <div class='side-by-side'>
                                                <button type='button' class='action-buttons edit-student-button'><i class='fa fa-pencil'></i> Edit</button>
                                            </div>
                                            <div class='side-by-side'>
                                                <button type='button' class='action-buttons delete-student-button'><i class='fa fa-trash-o'></i>Delete</button>
                                            </div>
                                            </div>
                                            
                                            <div class='row m-auto text-center'>
                                                <button type='button' class='action-buttons student-contact-button' data-toggle='collapse' data-target='.collapseRow$dynamicRowId'><i class='fa fa-phone'></i> Contact</button>
                                            </div>
                                        </div>
                                        ...
                                        <div class='right-action-buttons-container'>
                                            ...
                                            <div class='row '>
                                                <button type='button' class='action-buttons view-allergies-button'><i class='fa fa-bullhorn'></i>Allergies</button>
                                            </div>
                                            <div class='row '>
                                                <button type='button' class='action-buttons test-scores-button'><i class='fa fa-bar-chart'></i>Test Scores</button>
                                            </div>
                                        </div>    
                                    </td>
                                </tr>";
